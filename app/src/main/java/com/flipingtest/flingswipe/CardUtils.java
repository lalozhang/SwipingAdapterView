package com.flipingtest.flingswipe;
...
public class CardUtils {
    ...
    public static FrameLayout.LayoutParams getMoveParams(View v, int upDown,int leftRight){
        FrameLayout.LayoutParams original = (FrameLayout.LayoutParams)v.getLayoutParams();
        //RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(original);
        FrameLayout.LayoutParams params = cloneParams(original);
    ...
    public static void move(View v, int upDown,int leftRight){
        FrameLayout.LayoutParams params = getMoveParams(v,upDown,leftRight);
        v.setLayoutParams(params);
    }

    public static FrameLayout.LayoutParams scaleFrom(View v, FrameLayout.LayoutParams params, int pixel) {
    ...
    public static FrameLayout.LayoutParams moveFrom(View v, FrameLayout.LayoutParams params, int leftRight, int upDown) {
        params = cloneParams(params);
        params.leftMargin += leftRight;
        params.rightMargin -= leftRight;
        params.topMargin -= upDown;
    ...
    public static FrameLayout.LayoutParams cloneParams(FrameLayout.LayoutParams params){
        FrameLayout.LayoutParams copy = new FrameLayout.LayoutParams(params.width,params.height);
